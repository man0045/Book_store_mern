      ...
      <div className='mt-8 px-4 lg:px-24 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
        ...
        {name.map((blog) => 
          <div key={blog._id} className=' mt-3 bg-white p-6 rounded-md shadow-md '>
            <h5 className='mb-2 text-3xl font-bold text-gray-900 dark:text-white'>{blog.Name}</h5>
            <p className='mb-5 text-base text-gray-500 dark:text-gray-400 sm:text-lg'>{blog.Blogs}</p>
            <h3 className='mb-5 text-base text-gray-800 dark:text-gray-900 sm:text-lg'>{blog.authorName}</h3>
            <h3 className='mb-5 text-bold text-gray-800 dark:text-gray-900 sm:text-lg'>{blog.bookTitle}</h3>
            <div className='flex space-x-4'>
              ...
              >
                <span className='text-left'>
                  ...
                  <Link
                    className="font-medium text-cyan-600 hover:underline dark:text-cyan-500 mr-5" to={`/admin/blog/EditBlogs/${blog._id}`}>
